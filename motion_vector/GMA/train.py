...
class Logger:
    ...
    def _print_training_status(self):
        ...
        time_left_hms = "{:02d}h{:02d}m{:02d}s".format(
            time_left_sec // 3600, time_left_sec % 3600 // 60,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=False,
        help=
        'If True, use learned upsampling, otherwise, use bilinear upsampling.')
